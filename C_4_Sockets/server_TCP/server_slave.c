...
//NOT dynamic output
static char* WriteIntoBash (int fd , M_pack_named* pack , struct pollfd* pollfds);
...
char* WriteIntoBash (int fd , M_pack_named* pack , struct pollfd* pollfds)
{
